      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="grid gap-14 lg:grid-cols-4">
          ...
          >
            ...
            <p className="mt-3 text-lg text-emerald-200 italic">
              {siteConfig.tagline}
            </p>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <Link href="#services" className="block hover:text-emerald-400 transition">
                Services
              </Link>

              <Link href="#why" className="block hover:text-emerald-400 transition">
                Why AbuPay
              </Link>

              <Link href="#reviews" className="block hover:text-emerald-400 transition">
                Testimonials
              </Link>

              <Link href="#faq" className="block hover:text-emerald-400 transition">
                FAQ
              </Link>
